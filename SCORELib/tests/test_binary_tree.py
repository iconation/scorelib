...
class Test(IconIntegrateTestBase):
    ...
    def test_create_node_ok(self):
        result = transaction_call_success(
            ...
            method='binarytree_create_node',
            params={'value': 'hello'},
            icon_service=self.icon_service
        )

    def test_set_left_child_ok(self):
        ...
        # Assume the output of the idfactory
        parent_id = 1
        left_id = 2
        ...
        result = transaction_call_success(
            ...
            from_=self._operator,
            to_=self._score_address,
            method='binarytree_set_left_child',
            params={'parent_id': parent_id, 'left_id': left_id},
            icon_service=self.icon_service
        )

    def test_set_right_child_ok(self):
        ...
        result = transaction_call_success(
            ...
            from_=self._operator,
            to_=self._score_address,
            method='binarytree_set_right_child',
            params={'parent_id': parent_id, 'right_id': right_id},
            icon_service=self.icon_service
        )

    def test_traverse_post_order_ok(self):
        ...
        # Create this tree: https://i.imgur.com/7b4zKmu.png
        result = transaction_call_success(
            super(),
            from_=self._operator,
            to_=self._score_address,
            method='binarytree_set_left_child',
            params={'parent_id': 1, 'left_id': 2},
            icon_service=self.icon_service
        )
        result = transaction_call_success(
            super(),
        ...
        self.assertEqual(icx_call(
            super(),
            from_=self._operator.get_address(),
            to_=self._score_address,
            method='binarytree_traverse_post_order',
            params={'root': 1},
            icon_service=self.icon_service
        ), postorder)
        ...
        self.assertEqual(icx_call(
            ...
            from_=self._operator.get_address(),
            to_=self._score_address,
            method='binarytree_traverse_pre_order',
            params={'root': 1},
            icon_service=self.icon_service
        ), preorder)
        ...
        self.assertEqual(icx_call(
            ...
            from_=self._operator.get_address(),
            to_=self._score_address,
            method='binarytree_traverse_in_order',
            params={'root': 1},
            icon_service=self.icon_service
        ), inorder)
