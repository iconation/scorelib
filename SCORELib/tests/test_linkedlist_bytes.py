...
class Test(IconIntegrateTestBase):
    ...
    def test_append_1(self):
        length = icx_call(
            ...
            method='linkedlistdb_bytes_length',
        ...
        result = transaction_call_success(
            ...
            to_=self._score_address,
            method='linkedlistdb_bytes_append',
            params={'item': str(self._operator.get_address()).encode()},
            icon_service=self.icon_service
        )
        length = icx_call(
            super(),
    ...
    def test_append_3(self):
        ...
        result = transaction_call_success(
            ...
            to_=self._score_address,
            method='linkedlistdb_bytes_append',
            params={'item': str(self._user3.get_address()).encode()},
            icon_service=self.icon_service
        )
        length = icx_call(
            super(),
    ...
    def test_append_after_1(self):
        ...
        result = transaction_call_success(
            ...
            to_=self._score_address,
            method='linkedlistdb_bytes_append',
            params={'item': str(self._user.get_address()).encode()},
            icon_service=self.icon_service
        )
        ...
        result = transaction_call_success(
            ...
            from_=self._operator,
            to_=self._score_address,
            method='linkedlistdb_bytes_append_after',
            params={'item': str(self._user2.get_address()).encode(), 'after_id': 1},
            icon_service=self.icon_service
        )
        ...
        linkedlistdb = icx_call(
            ...
            from_=self._operator.get_address(),
            to_=self._score_address,
            method='linkedlistdb_bytes_selectall',
            params={'offset': 0},
            icon_service=self.icon_service
        )
    ...
    def test_next(self):
        ...
        next_id = icx_call(
            ...
            from_=self._operator.get_address(),
            to_=self._score_address,
            method='linkedlistdb_bytes_next',
            params={'next_id': 1},
            icon_service=self.icon_service
        )
    ...
    def test_prev(self):
        ...
        prev_id = icx_call(
            ...
            from_=self._operator.get_address(),
            to_=self._score_address,
            method='linkedlistdb_bytes_prev',
            params={'prev_id': 2},
            icon_service=self.icon_service
        )
    ...
    def test_move_node_before(self):
        ...
        result = transaction_call_success(
            ...
            to_=self._score_address,
            method='linkedlistdb_bytes_append',
            params={'item': str(self._user2.get_address()).encode()},
            icon_service=self.icon_service
        )
        result = transaction_call_success(
            super(),
            from_=self._operator,
            to_=self._score_address,
            method='linkedlistdb_bytes_move_node_before',
    ...
    def test_move_node_after_1(self):
        ...
        result = transaction_call_success(
            ...
            from_=self._operator,
            to_=self._score_address,
            method='linkedlistdb_bytes_move_node_after',
    ...
    def test_prepend_1(self):
        result = transaction_call_success(
            ...
            from_=self._operator,
            to_=self._score_address,
            method='linkedlistdb_bytes_prepend',
            params={'item': str(self._operator.get_address()).encode()},
            icon_service=self.icon_service
        )
        length = icx_call(
    ...
    def test_prepend_2(self):
        ...
        self.assertTrue(linkedlistdb[0][1] == str(self._operator.get_address()).encode())
        self.assertTrue(linkedlistdb[1][1] == str(self._operator.get_address()).encode())
    ...
    def test_prepend_3(self):
        ...
        self.assertTrue(linkedlistdb[0][1] == self._operator.get_address().encode())
        self.assertTrue(linkedlistdb[1][1] == self._operator.get_address().encode())
        self.assertTrue(linkedlistdb[2][1] == self._user3.get_address().encode())
    ...
    def test_prepend_before_1(self):
        ...
        result = transaction_call_success(
            ...
            from_=self._operator,
            to_=self._score_address,
            method='linkedlistdb_bytes_prepend_before',
            params={'item': str(self._user2.get_address()).encode(), 'before_id': 1},
            icon_service=self.icon_service
        )
    ...
    def test_prepend_before_2(self):
        ...
        result = transaction_call_success(
            ...
            to_=self._score_address,
            method='linkedlistdb_bytes_prepend_before',
            params={'item': str(self._user2.get_address()).encode(), 'before_id': 3},
            icon_service=self.icon_service
        )
    ...
    def test_append_after_2(self):
        ...
        result = transaction_call_success(
            ...
            to_=self._score_address,
            method='linkedlistdb_bytes_append_after',
            params={'item': str(self._user2.get_address()).encode(), 'after_id': 3},
            icon_service=self.icon_service
        )
    ...
    def test_clear(self):
        ...
        result = transaction_call_success(
            ...
            from_=self._operator,
            to_=self._score_address,
            method='linkedlistdb_bytes_clear',
            icon_service=self.icon_service
        )
        length = icx_call(
            super(),
    ...
    def test_remove_1(self):
        ...
        result = transaction_call_success(
            ...
            from_=self._operator,
            to_=self._score_address,
            method='linkedlistdb_bytes_remove',
            params={'node_id': 1},
            icon_service=self.icon_service
        )
        length = icx_call(
    ...
    def test_select_1(self):
        ...
        linkedlistdb = icx_call(
            ...
            from_=self._operator.get_address(),
            to_=self._score_address,
            method='linkedlistdb_bytes_select',
            params={'offset': 0, 'match': str(self._operator.get_address()).encode()},
            icon_service=self.icon_service
        )
    ...
    def test_remove_head(self):
        ...
        result = transaction_call_success(
            ...
            from_=self._operator,
            to_=self._score_address,
            method='linkedlistdb_bytes_remove_head',
            icon_service=self.icon_service
        )
        linkedlistdb = icx_call(
            super(),
    ...
    def test_remove_tail(self):
        ...
        result = transaction_call_success(
            ...
            from_=self._operator,
            to_=self._score_address,
            method='linkedlistdb_bytes_remove_tail',
            icon_service=self.icon_service
        )
        linkedlistdb = icx_call(
            super(),
